...
for i, city in enumerate(["Tokyo", "Osaka", "Fukuoka"]):
        ...
        if not city_data.empty:
            ...
            if np.count_nonzero(y) > 0:
                ...
                bars = plt.bar(x, y, bar_width,
                               alpha=opacity,
                               color=year_colors.get(year, "gray"))  # 이 부분을 수정했습니다.
    ...
    legend = plt.legend(handles, labels, loc='upper right', bbox_to_anchor=(1, 1), fontsize='small')  # Adjust the legend position and size
